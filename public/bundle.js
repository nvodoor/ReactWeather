		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement('input', { type: 'text', ref: 'location', placeholder: 'Enter Weather' }),
					React.createElement(
						'button',
						null,
						'Get Weather!'
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=b5a9fa1fb2815ceda28b2046fbe8535b&units=imperial';
